...
contract IIPClaimsLicense is IOwnableUpgradableImplementation {
    ...
    function initWithParameters(uint256 _feeInUSD, uint32 _commissionPercentage, address _feeReceiver, address _ipToken,
