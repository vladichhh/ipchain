...
import "./IIPClaimsShareUpgrade.sol";
...
contract IPClaimsShareUpgrade is IIPClaimsShareUpgrade, OwnableUpgradableImplementation {
    ...
    function shareIPClaim(address _claim, address _recipient, bytes32 _ndaHash) public
        ...
        require(_recipient != IPClaim(_claim).owner(), "Can not share IP claim with its owner");
        ...
        assert(ipToken.transferFrom(msg.sender, feeReceiver, feeInTokens));
    ...
    function setTestParameter(address _testParameter) public onlyOwner {
