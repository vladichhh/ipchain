...
import "./IIPClaimsFactory.sol";
import "./../IPClaim/IPClaim.sol";
import "../TestContracts/Token/ERC20.sol";
import "../Oracle/TokenExchangeOracle.sol";


contract IPClaimsFactory is IIPClaimsFactory, OwnableUpgradableImplementation {

    IIPClaimsRegistry public registry;
    ...
    */
    ...
    onlyValidAddress(_tokenExchangeOracle) {
        ...
        registry = IIPClaimsRegistry(_registry);
    ...
    function createPrivateClaim(bytes32 _privateIPFSAddress, uint8 _claimType) public {
        require(_privateIPFSAddress != bytes32(0));
        createClaim(_privateIPFSAddress, bytes32(0), _claimType, false);
    }

    function createPublicClaim(bytes32 _publicIPFSAddress, uint8 _claimType) public {
